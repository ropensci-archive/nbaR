...
#'
#' @details Model class for Filter objects. 
#'
#'
  ...
  public = list(
    ...
    `acceptRegexp`,
      ...
      if (!missing(`rejectValues`)) {
        stopifnot(is.list(`rejectValues`),
