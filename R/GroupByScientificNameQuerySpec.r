  ...
  public = list(
    ...
    `constantScore`,
      ...
      if (!missing(`groupSort`)) {
        stopifnot(is.character(`groupSort`),
                  length(`groupSort`) == 1)
