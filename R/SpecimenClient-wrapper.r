...
#' @export
specimen_count_distinct_values_per_group <- function(group = NULL,
                                                     field = NULL,
...
#' @export
specimen_download_query <- function(collectionType = NULL,
                                    queryParams = list(),
                                    ...) {
  sc <- SpecimenClient$new()
...
#' @export
specimen_dwca_get_data_set <- function(dataset = NULL,
    ...) {
  sc <- SpecimenClient$new()
...
#' @export
specimen_dwca_get_data_set_names <- function(returnType = "data.frame",
    ...) {
  sc <- SpecimenClient$new()
...
#' @title Returns whether or not the provided unitID is a valid (in-use) unitID
...
#' @export
specimen_exists <- function(unitID = NULL,
    ...) {
  sc <- SpecimenClient$new()
  res <- sc$exists(
    unitID,
...
#' @name specimen_find
#' @title Find a specimen by its Elasticsearch document ID
#' @description This is a wrapper for the method \code{ find }
#' from class \code{ SpecimenClient}.
#' @details If found, returns a single specimen. Note that NBA document IDs are not auto-generated, so they are stable across dataset imports.
#' @family nbaR.SpecimenClient-wrappers
...
#' @export
specimen_find <- function(id = NULL,
                          returnType = "data.frame",
                          ...) {
...
#' @title Find specimens by their Elasticsearch document IDs
...
#' @export
specimen_find_by_ids <- function(ids = NULL,
                                 returnType = "data.frame",
                                 ...) {
  ## check returnType argument
  if (!returnType %in% c("list", "data.frame")) {
...
#' @export
specimen_find_by_unit_id <- function(unitID = NULL,
                                     returnType = "data.frame",
                                     ...) {
  ## check returnType argument
  if (!returnType %in% c("list", "data.frame")) {
...
#' @export
specimen_get_distinct_values <- function(field = NULL,
                                         returnType = "data.frame",
                                         ...) {
  sc <- SpecimenClient$new()
...
#' @export
specimen_get_distinct_values_per_group <- function(group = NULL,
                                                   field = NULL,
                                                   returnType = "data.frame",
                                                   ...) {
  sc <- SpecimenClient$new()
...
#' @export
specimen_get_field_info <- function(returnType = "data.frame",
    ...) {
  sc <- SpecimenClient$new()
...
#' @export
specimen_get_paths <- function(returnType = "data.frame",
    ...) {
  sc <- SpecimenClient$new()
  res <- sc$get_paths(
    ...
...
#' @export
specimen_get_settings <- function(returnType = "data.frame",
    ...) {
  sc <- SpecimenClient$new()
  res <- sc$get_settings(
    ...
...
#' @param ... additional parameters passed to get_settings from class nbaR.SpecimenClient
#' @export
specimen_get_settings <- function(name = NULL,
    ...) {
  sc <- SpecimenClient$new()
  res <- sc$get_settings(
    name,
...
#' @export
specimen_group_by_scientific_name <- function(collectionType = NULL,
                                              queryParams = list(),
                                              returnType = "data.frame",
                                              ...) {
  ## check returnType argument
...
#' @export
specimen_is_operator_allowed <- function(field = NULL,
                                         operator = NULL,
                                         returnType = "data.frame",
                                         ...) {
  sc <- SpecimenClient$new()
...
#' @export
specimen_query <- function(collectionType = NULL,
                           queryParams = list(),
                           returnType = "data.frame",
                           ...) {
  ## check returnType argument
...
#' @name specimen_query_with_name_resolution
#' @title
...
#' @param queryParams Named list or vector with names being the fields to be queried and values being the values to match
#' @param ... additional parameters passed to query_with_name_resolution from class nbaR.SpecimenClient
#' @export
specimen_query_with_name_resolution <- function(.querySpec = NULL,
                                                queryParams = list(),
                                                ...) {
  sc <- SpecimenClient$new()
