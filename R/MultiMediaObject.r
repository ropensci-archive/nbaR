  ...
  public = list(
    ...
    `sourceSystem`,
      ...
      if (!missing(`sourceInstitutionID`)) {
        stopifnot(is.character(`sourceInstitutionID`),
                  length(`sourceInstitutionID`) == 1)
        self[["sourceInstitutionID"]] <- `sourceInstitutionID`
      }
      if (!missing(`sourceID`)) {
        stopifnot(is.character(`sourceID`),
                  length(`sourceID`) == 1)
        self[["sourceID"]] <- `sourceID`
      }
      if (!missing(`previousSourceID`)) {
        stopifnot(is.list(`previousSourceID`),
                  length(`previousSourceID`) != 0)
        lapply(`previousSourceID`,
      ...
      if (!missing(`licenseType`)) {
        stopifnot(is.character(`licenseType`),
      ...
      if (!missing(`caption`)) {
        stopifnot(is.character(`caption`),
                  length(`caption`) == 1)
      ...
      if (!missing(`serviceAccessPoints`)) {
        stopifnot(is.list(`serviceAccessPoints`),
                  length(`serviceAccessPoints`) != 0)
        lapply(`serviceAccessPoints`,
      ...
      if (!missing(`taxonCount`)) {
        stopifnot(is.numeric(`taxonCount`),
                  length(`taxonCount`) == 1)
        self[["taxonCount"]] <- `taxonCount`
      }
      if (!missing(`creator`)) {
        stopifnot(is.character(`creator`),
                  length(`creator`) == 1)
        self[["creator"]] <- `creator`
      }
      if (!missing(`copyrightText`)) {
        stopifnot(is.character(`copyrightText`),
                  length(`copyrightText`) == 1)
        self[["copyrightText"]] <- `copyrightText`
      }
      if (!missing(`associatedSpecimenReference`)) {
        stopifnot(is.character(`associatedSpecimenReference`),
      ...
      if (!missing(`associatedTaxonReference`)) {
        stopifnot(is.character(`associatedTaxonReference`),
      ...
      if (!missing(`dateLastEdited`)) {
        stopifnot(is.character(`dateLastEdited`),
