...
#' @export
metadata_get_allowed_date_formats <- function(returnType = "data.frame",
    ...) {
...
#' @export
metadata_get_controlled_list_area_class <- function(returnType = "data.frame",
    ...) {
  sc <- MetadataClient$new()
...
#' @export
metadata_get_controlled_list_license <- function(returnType = "data.frame",
    ...) {
  sc <- MetadataClient$new()
...
#' @export
metadata_get_controlled_list_license_type <- function(returnType = "data.frame",
    ...) {
  sc <- MetadataClient$new()
...
#' @export
metadata_get_controlled_list_sex <- function(returnType = "data.frame",
    ...) {
  sc <- MetadataClient$new()
...
#' @export
metadata_get_controlled_list_spatial_datum <- function(returnType = "data.frame",
    ...) {
  sc <- MetadataClient$new()
...
#' @export
metadata_get_controlled_list_specimen_type_status <- function(returnType = "data.frame",
    ...) {
  sc <- MetadataClient$new()
...
#' @export
metadata_get_controlled_list_taxon_relation_type <- function(returnType = "data.frame",
    ...) {
  sc <- MetadataClient$new()
...
#' @export
metadata_get_controlled_list_taxonomic_status <- function(returnType = "data.frame",
    ...) {
  sc <- MetadataClient$new()
...
#' @export
metadata_get_controlled_lists <- function(returnType = "data.frame",
    ...) {
  sc <- MetadataClient$new()
...
#' @export
metadata_get_rest_services <- function(returnType = "data.frame",
    ...) {
...
#' @export
metadata_get_setting <- function(name = NULL,
    ...) {
  sc <- MetadataClient$new()
  res <- sc$get_setting(
    name,
...
#' @export
metadata_get_settings <- function(returnType = "data.frame",
    ...) {
  sc <- MetadataClient$new()
  res <- sc$get_settings(
    ...
...
#' @export
metadata_get_source_systems <- function(returnType = "data.frame",
    ...) {
  ## check returnType argument
  if (!returnType %in% c("list", "data.frame")) {
    stop("Invalid returnType argument. Must be 'data.frame' or 'list'")
