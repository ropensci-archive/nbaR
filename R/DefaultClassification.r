  ...
  public = list(
    ...
    `domain`,
      ...
      if (!missing(`subKingdom`)) {
        stopifnot(is.character(`subKingdom`),
                  length(`subKingdom`) == 1)
        self[["subKingdom"]] <- `subKingdom`
      }
      if (!missing(`kingdom`)) {
        stopifnot(is.character(`kingdom`),
                  length(`kingdom`) == 1)
        self[["kingdom"]] <- `kingdom`
      }
      if (!missing(`phylum`)) {
        stopifnot(is.character(`phylum`),
                  length(`phylum`) == 1)
        self[["phylum"]] <- `phylum`
      }
      if (!missing(`subPhylum`)) {
        stopifnot(is.character(`subPhylum`),
                  length(`subPhylum`) == 1)
        self[["subPhylum"]] <- `subPhylum`
      }
      if (!missing(`superClass`)) {
        stopifnot(is.character(`superClass`),
                  length(`superClass`) == 1)
        self[["superClass"]] <- `superClass`
      }
      if (!missing(`className`)) {
        stopifnot(is.character(`className`),
                  length(`className`) == 1)
      ...
      if (!missing(`superOrder`)) {
        stopifnot(is.character(`superOrder`),
                  length(`superOrder`) == 1)
      ...
      if (!missing(`subOrder`)) {
        stopifnot(is.character(`subOrder`),
                  length(`subOrder`) == 1)
        self[["subOrder"]] <- `subOrder`
      }
      if (!missing(`infraOrder`)) {
        stopifnot(is.character(`infraOrder`),
                  length(`infraOrder`) == 1)
        self[["infraOrder"]] <- `infraOrder`
      }
      if (!missing(`superFamily`)) {
        stopifnot(is.character(`superFamily`),
      ...
      if (!missing(`subFamily`)) {
        stopifnot(is.character(`subFamily`),
                  length(`subFamily`) == 1)
        self[["subFamily"]] <- `subFamily`
      }
      if (!missing(`tribe`)) {
        stopifnot(is.character(`tribe`),
                  length(`tribe`) == 1)
        self[["tribe"]] <- `tribe`
      }
      if (!missing(`subTribe`)) {
        stopifnot(is.character(`subTribe`),
                  length(`subTribe`) == 1)
        self[["subTribe"]] <- `subTribe`
      }
      if (!missing(`genus`)) {
        stopifnot(is.character(`genus`),
                  length(`genus`) == 1)
        self[["genus"]] <- `genus`
      }
      if (!missing(`subgenus`)) {
        stopifnot(is.character(`subgenus`),
                  length(`subgenus`) == 1)
        self[["subgenus"]] <- `subgenus`
      }
      if (!missing(`specificEpithet`)) {
        stopifnot(is.character(`specificEpithet`),
                  length(`specificEpithet`) == 1)
        self[["specificEpithet"]] <- `specificEpithet`
      }
      if (!missing(`infraspecificEpithet`)) {
        stopifnot(is.character(`infraspecificEpithet`),
                  length(`infraspecificEpithet`) == 1)
        self[["infraspecificEpithet"]] <- `infraspecificEpithet`
      }
      if (!missing(`infraspecificRank`)) {
        stopifnot(is.character(`infraspecificRank`),
